      ...
      `}</style>
            ...
            <header className="flex items-center justify-between border-b border-slate-200 px-10 py-4 bg-white z-10 relative">
                <div className="flex items-center gap-4">
                    <div className="flex items-center justify-center size-10 rounded-full bg-rose-500/10 text-rose-500">
            ...
            <main className="flex-1 flex flex-col items-center justify-center p-6 relative">
                ...
                <div className="w-full max-w-[560px] bg-white rounded-xl border border-slate-100 shadow-xl p-8 md:p-12 z-0 flex flex-col items-center">
                    ...
                    <div className="relative mb-10 size-48 flex items-center justify-center">
                        <div className="absolute inset-0 border-2 border-rose-500/20 rounded-full pulse-ring" />
                        <div className="absolute inset-4 border border-rose-500/10 rounded-full pulse-ring" style={{ animationDelay: "0.5s" }} />
                        <div className="relative z-10 flex items-center justify-center size-32 bg-rose-500/5 rounded-full overflow-hidden border border-rose-500/10">
                            <span className="material-symbols-outlined text-rose-500/40" style={{ fontSize: 80 }}>face</span>
                            <div className="absolute w-full h-1 bg-gradient-to-r from-transparent via-rose-500 to-transparent scan-line shadow-[0_0_15px_rgba(240,66,124,0.6)]" />
                        </div>
                        <div className="absolute top-0 right-10 text-rose-500 animate-bounce" style={{ animationDuration: "3s" }}>
                            <span className="material-symbols-outlined text-xs">auto_awesome</span>
                        </div>
                        <div className="absolute bottom-4 left-4 text-rose-500 animate-bounce" style={{ animationDuration: "4s" }}>
                    ...
                    <div className="h-6 mb-8 overflow-hidden relative w-full flex justify-center">
                        <p className="text-rose-500 text-base font-medium animate-pulse">Matching your smile...</p>
                    </div>
                    ...
                    <div className="w-full flex flex-col gap-3 mb-8">
                        ...
                        <div className="h-3 w-full bg-slate-100 rounded-full overflow-hidden">
                            <div className="h-full bg-rose-500 rounded-full relative" style={{ width: "72%" }}>
