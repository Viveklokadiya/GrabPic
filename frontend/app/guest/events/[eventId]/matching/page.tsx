            ...
            <main className="flex-1 flex flex-col items-center justify-center p-6 relative">
                ...
                <div className="w-full max-w-[560px] bg-white rounded-xl border border-slate-100 shadow-xl p-8 md:p-12 z-0 flex flex-col items-center">
                    ...
                    <div className="relative mb-10 size-48 flex items-center justify-center">
                        <div className="absolute inset-0 border-2 border-blue-500/20 rounded-full pulse-ring" />
                        <div className="absolute inset-4 border border-blue-500/10 rounded-full pulse-ring" style={{ animationDelay: "0.5s" }} />
                        <div className="relative z-10 flex items-center justify-center size-32 bg-blue-500/5 rounded-full overflow-hidden border border-blue-500/10">
                            <span className="material-symbols-outlined text-blue-500/40" style={{ fontSize: 80 }}>face</span>
                            <div className="absolute w-full h-1 bg-gradient-to-r from-transparent via-blue-500 to-transparent scan-line shadow-[0_0_15px_rgba(37,99,235,0.6)]" />
                        </div>
                        <div className="absolute top-0 right-10 text-blue-500 animate-bounce" style={{ animationDuration: "3s" }}>
                            <span className="material-symbols-outlined text-xs">auto_awesome</span>
                        </div>
                        <div className="absolute bottom-4 left-4 text-blue-500 animate-bounce" style={{ animationDuration: "4s" }}>
                    ...
                    <div className="h-6 mb-8 overflow-hidden relative w-full flex justify-center">
                        <p className="text-blue-500 text-base font-medium animate-pulse">Matching your smile...</p>
                    </div>
                    ...
                    <div className="w-full flex flex-col gap-3 mb-8">
                        ...
                        <div className="h-3 w-full bg-slate-100 rounded-full overflow-hidden">
                            <div className="h-full bg-blue-500 rounded-full relative" style={{ width: "72%" }}>
