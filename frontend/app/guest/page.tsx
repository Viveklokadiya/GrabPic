      ...
      <main className="flex-grow max-w-6xl mx-auto w-full px-4 py-10 flex flex-col gap-10">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-7">
            <div className="h-full bg-white rounded-3xl p-8 shadow-sm border border-slate-100 relative overflow-hidden group hover:border-rose-200 transition-all duration-300">
              <div className="absolute top-0 right-0 p-8 opacity-5 pointer-events-none">
                <span className="material-symbols-outlined text-[180px] text-rose-500 rotate-12">qr_code_scanner</span>
              </div>
              <div className="relative z-10 flex flex-col h-full justify-between">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link href="/guest/join" className="flex-1 flex items-center justify-center gap-3 bg-rose-500 hover:bg-rose-600 text-white py-4 px-6 rounded-xl font-bold text-lg shadow-lg shadow-rose-500/20 hover:-translate-y-0.5 transition-all">
                    <span className="material-symbols-outlined">qr_code_scanner</span>
                    Scan QR Code
                  </Link>
                  <Link href="/guest/join" className="flex-1 flex items-center justify-center gap-3 bg-white border-2 border-slate-200 hover:border-rose-300 hover:bg-rose-50/30 text-slate-700 py-4 px-6 rounded-xl font-semibold text-lg transition-all">
          ...
          <div className="lg:col-span-5">
            <div className="h-full bg-slate-900 text-white rounded-3xl p-8 shadow-sm relative overflow-hidden flex flex-col justify-center">
              ...
              <div className="absolute -bottom-20 -right-20 w-64 h-64 bg-rose-500/20 rounded-full blur-3xl" />
              <div className="relative z-10">
                <div className="flex items-center gap-3 mb-6 opacity-90">
                  <span className="material-symbols-outlined text-rose-400">keyboard</span>
                ...
                <form onSubmit={onJoin} className="space-y-4">
                  <div>
                    <input
                      className="w-full bg-slate-800/50 border border-slate-700 focus:border-rose-400 focus:ring-1 focus:ring-rose-400 rounded-xl px-5 py-4 text-lg text-white placeholder:text-slate-500 font-mono tracking-widest transition-all focus:outline-none"
                      placeholder="ABC-123"
                      value={eventCode}
          ...
          <div className="flex items-end justify-between mb-6 border-b border-slate-200 pb-4">
            ...
            <div className="flex items-center gap-3">
              <div className="relative">
                ...
                <input
                  className="pl-9 pr-4 py-2 rounded-lg border border-slate-200 bg-white text-sm focus:outline-none focus:border-rose-300 focus:ring-2 focus:ring-rose-100"
                  placeholder="Search events..."
                  value={search}
                  onChange={(e) => setSearch(e.target.value)}
                />
              </div>
              <Link href="/guest/history" className="text-rose-500 hover:text-rose-600 text-sm font-semibold flex items-center gap-1 transition-colors">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
              {filtered.map((item) => (
                <Link
                  ...
                  className="group bg-white rounded-2xl border border-slate-200 hover:border-rose-200 hover:shadow-md transition-all p-5 flex items-center gap-5"
                >
                  ...
                  <div className="flex flex-col min-w-0 flex-grow">
                    <h4 className="text-slate-900 font-bold text-base truncate group-hover:text-rose-500 transition-colors">{item.name}</h4>
                  ...
                  <div className="flex-shrink-0 text-slate-300 group-hover:text-rose-400 transition-colors">
              ...
              <Link
                href="/guest/join"
                className="group bg-white rounded-2xl border-2 border-dashed border-slate-200 hover:border-rose-300 hover:bg-rose-50/30 transition-all p-5 flex flex-col items-center justify-center min-h-[120px] gap-3"
              >
                <div className="h-12 w-12 rounded-full bg-white shadow-sm flex items-center justify-center text-rose-400 group-hover:scale-110 transition-transform">
